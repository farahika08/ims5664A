...
--
-- Host: localhost:3306
-- Generation Time: Mar 01, 2024 at 06:35 AM
...
(19, 'Shazurin', '123456789', NULL, NULL, '1011139', 'Female', 'Puchong, Selangor', 'Petaling Jaya, Selangor', 'MY', 'Selangor', '47100', '1011441011139', 'Demo Branch ', '1011', '6789022110', 1000.00, 0, '0192310923', 'shzrn12@gmail.com', '421368591567', 6755, NULL, '1990-05-24', 'Puchong Utama', '29/02/24 04:39:58 PM', '27/02/24 05:35:23 PM', 'ACTIVE', 'Saving'),
(24, 'kopo', 'Khairol12@', NULL, NULL, '1011179', 'Female', '158, lorong masjid haji kadir, pasir panjang', 'Machang, Kelantan', 'MY', 'Kuala Lumpur', '21100', '1011571011179', 'Demo Branch ', '1011', '696969', NULL, 0, '0179524315', '2022854774@student.uitm.edu.my', '421347278611', 3552, NULL, '2004-04-11', 'Ulu Sat', NULL, '29/02/24 06:21:03 PM', 'ACTIVE', 'Current'),
(23, 'kopo', '123456789', NULL, NULL, '1011144', 'Male', '158, lorong masjid haji kadir, pasir panjang', 'Machang, Kelantan', 'MY', 'Kuala Lumpur', '21100', '1011671011144', 'Demo Branch ', '1011', '696969', NULL, 0, '0179524315', '2022854774@student.uitm.edu.my', '421356434296', 4251, NULL, '2004-04-11', 'Ulu Sat', '29/02/24 05:59:34 PM', '29/02/24 05:53:02 PM', 'ACTIVE', 'Saving');
...
(1, 'Admin1', '210001', 'password', '7412225696', 'admin1@gmail.com', 'Male', 'Human Resource', '10121995', '14569855', 'Kuala Terengganu, Terengganu', '29/02/24 05:52:36 PM'),
...
--
-- Table structure for table `beneficiary_1011144`
--

CREATE TABLE `beneficiary_1011144` (
  `id` int(255) NOT NULL,
  `Beneficiary_name` varchar(255) DEFAULT NULL,
  `Beneficiary_ac_no` varchar(255) DEFAULT NULL,
  `IFSC_code` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `beneficiary_1011151`
--

CREATE TABLE `beneficiary_1011151` (
  `id` int(255) NOT NULL,
  `Beneficiary_name` varchar(255) DEFAULT NULL,
  `Beneficiary_ac_no` varchar(255) DEFAULT NULL,
  `IFSC_code` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `beneficiary_1011179`
--

CREATE TABLE `beneficiary_1011179` (
  `id` int(255) NOT NULL,
  `Beneficiary_name` varchar(255) DEFAULT NULL,
  `Beneficiary_ac_no` varchar(255) DEFAULT NULL,
  `IFSC_code` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `beneficiary_1011291`
--

INSERT INTO `beneficiary_1011291` (`id`, `Beneficiary_name`, `Beneficiary_ac_no`, `IFSC_code`, `Account_type`, `Status`, `Date_added`) VALUES
(1, 'Nur Ameera', '1011301011291', '1011', 'Saving', 'ACTIVE', '27/02/24 06:20:14 PM'),
(2, 'Nur Nasirah', '1011511011382', '1011', 'Current', 'ACTIVE', '28/02/24 06:20:14 PM');
...
--
-- Dumping data for table `beneficiary_1011316`
--

INSERT INTO `beneficiary_1011316` (`id`, `Beneficiary_name`, `Beneficiary_ac_no`, `IFSC_code`, `Account_type`, `Status`, `Date_added`) VALUES
(1, 'Nur Ameera', '1011301011291', '1011', 'Saving', 'ACTIVE', '27/02/24 06:20:14 PM'),
(2, 'Adam Fatihi', '1011731011390', '1011', 'Current', 'ACTIVE', '27/02/24 06:20:49 PM');
...
--
-- Dumping data for table `beneficiary_1011382`
--

INSERT INTO `beneficiary_1011382` (`id`, `Beneficiary_name`, `Beneficiary_ac_no`, `IFSC_code`, `Account_type`, `Status`, `Date_added`) VALUES
(1, 'Nur Ameera', '1011301011291', '1011', 'Saving', 'ACTIVE', '27/02/24 06:20:14 PM'),
(2, 'Adam Fatihi', '1011731011390', '1011', 'Current', 'ACTIVE', '27/02/24 06:20:49 PM');
...
--
-- Dumping data for table `beneficiary_1011390`
--

INSERT INTO `beneficiary_1011390` (`id`, `Beneficiary_name`, `Beneficiary_ac_no`, `IFSC_code`, `Account_type`, `Status`, `Date_added`) VALUES
(1, 'Nur Ameera', '1011301011291', '1011', 'Saving', 'ACTIVE', '27/02/24 06:20:14 PM'),
(2, 'Nur Nasirah', '1011511011382', '1011', 'Current', 'ACTIVE', '28/02/24 06:20:14 PM\r\n');
...
--
-- Dumping data for table `beneficiary_1011549`
--

INSERT INTO `beneficiary_1011549` (`id`, `Beneficiary_name`, `Beneficiary_ac_no`, `IFSC_code`, `Account_type`, `Status`, `Date_added`) VALUES
(1, 'Nur Ameera', '1011301011291', '1011', 'Saving', 'ACTIVE', '27/02/24 06:20:14 PM'),
(2, 'Adam Fatihi', '1011731011390', '1011', 'Current', 'ACTIVE', '27/02/24 06:20:49 PM');
...
--
-- Dumping data for table `beneficiary_1011610`
--

INSERT INTO `beneficiary_1011610` (`id`, `Beneficiary_name`, `Beneficiary_ac_no`, `IFSC_code`, `Account_type`, `Status`, `Date_added`) VALUES
(1, 'Nur Ameera', '1011301011291', '1011', 'Saving', 'ACTIVE', '28/02/24 06:20:14 PM'),
(2, 'Adam Fatihi', '1011731011390', '1011', 'Current', 'ACTIVE', '28/02/24 06:20:14 PM');

-- --------------------------------------------------------

--
-- Table structure for table `beneficiary_1011782`
--

CREATE TABLE `beneficiary_1011782` (
  `id` int(255) NOT NULL,
  `Beneficiary_name` varchar(255) DEFAULT NULL,
  `Beneficiary_ac_no` varchar(255) DEFAULT NULL,
  `IFSC_code` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `beneficiary_1011798`
--

INSERT INTO `beneficiary_1011798` (`id`, `Beneficiary_name`, `Beneficiary_ac_no`, `IFSC_code`, `Account_type`, `Status`, `Date_added`) VALUES
(1, 'Nur Ameera', '1011301011291', '1011', 'Saving', 'ACTIVE', '28/02/24 06:20:14 PM'),
(2, 'Adam Fatihi', '1011731011390', '1011', 'Current', 'ACTIVE', '28/02/24 06:20:14 PM');
...
--
-- Dumping data for table `beneficiary_1011897`
--

INSERT INTO `beneficiary_1011897` (`id`, `Beneficiary_name`, `Beneficiary_ac_no`, `IFSC_code`, `Account_type`, `Status`, `Date_added`) VALUES
(1, 'Nur Ameera', '1011301011291', '1011', 'Saving', 'ACTIVE', '28/02/24 06:20:14 PM'),
(2, 'Adam Fatihi', '1011731011390', '1011', 'Current', 'ACTIVE', '28/02/24 06:20:14 PM');
...
--
-- Dumping data for table `beneficiary_1011905`
--

INSERT INTO `beneficiary_1011905` (`id`, `Beneficiary_name`, `Beneficiary_ac_no`, `IFSC_code`, `Account_type`, `Status`, `Date_added`) VALUES
(1, 'Nur Ameera', '1011301011291', '1011', 'Saving', 'ACTIVE', '28/02/24 06:20:14 PM'),
(2, 'Adam Fatihi', '1011731011390', '1011', 'Current', 'ACTIVE', '28/02/24 06:20:14 PM');
...
--
-- Dumping data for table `beneficiary_1011958`
--

INSERT INTO `beneficiary_1011958` (`id`, `Beneficiary_name`, `Beneficiary_ac_no`, `IFSC_code`, `Account_type`, `Status`, `Date_added`) VALUES
(1, 'Nur Ameera', '1011301011291', '1011', 'Saving', 'ACTIVE', '28/02/24 06:20:14 PM'),
(2, 'Adam Fatihi', '1011731011390', '1011', 'Current', 'ACTIVE', '28/02/24 06:20:14 PM');
...
--
-- Table structure for table `passbook_1011144`
--

CREATE TABLE `passbook_1011144` (
  `id` int(255) NOT NULL,
  `Transaction_id` varchar(255) DEFAULT NULL,
  `Transaction_date` varchar(255) DEFAULT NULL,
  `Description` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `passbook_1011144`
--

INSERT INTO `passbook_1011144` (`id`, `Transaction_id`, `Transaction_date`, `Description`, `Cr_amount`, `Dr_amount`, `Net_Balance`, `Remark`) VALUES
(1, '350713814', '29/02/24 05:53:02 PM', 'Account Opening', '0', '0', '0', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `passbook_1011151`
--

CREATE TABLE `passbook_1011151` (
  `id` int(255) NOT NULL,
  `Transaction_id` varchar(255) DEFAULT NULL,
  `Transaction_date` varchar(255) DEFAULT NULL,
  `Description` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `passbook_1011151`
--

INSERT INTO `passbook_1011151` (`id`, `Transaction_id`, `Transaction_date`, `Description`, `Cr_amount`, `Dr_amount`, `Net_Balance`, `Remark`) VALUES
(1, '148654248', '29/02/24 05:46:44 PM', 'Account Opening', '0', '0', '0', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `passbook_1011179`
--

CREATE TABLE `passbook_1011179` (
  `id` int(255) NOT NULL,
  `Transaction_id` varchar(255) DEFAULT NULL,
  `Transaction_date` varchar(255) DEFAULT NULL,
  `Description` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `passbook_1011179`
--

INSERT INTO `passbook_1011179` (`id`, `Transaction_id`, `Transaction_date`, `Description`, `Cr_amount`, `Dr_amount`, `Net_Balance`, `Remark`) VALUES
(1, '818335743', '29/02/24 06:21:03 PM', 'Account Opening', '0', '0', '0', NULL);
...
(3, '380292776', '29/02/24 02:23:18 PM', 'Cash Deposit/380292776', '50', '0', '100', 'Cash Deposit');
...
--
-- Table structure for table `passbook_1011782`
--

CREATE TABLE `passbook_1011782` (
  `id` int(255) NOT NULL,
  `Transaction_id` varchar(255) DEFAULT NULL,
  `Transaction_date` varchar(255) DEFAULT NULL,
  `Description` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `passbook_1011782`
--

INSERT INTO `passbook_1011782` (`id`, `Transaction_id`, `Transaction_date`, `Description`, `Cr_amount`, `Dr_amount`, `Net_Balance`, `Remark`) VALUES
(1, '392882875', '29/02/24 05:41:16 PM', 'Account Opening', '0', '0', '0', NULL);
...
(' 849912979', 'Anis Anisa', 'Female', '0134234390', 'anissha@gmail.com', '2001-05-02', '6789209100', 'Pasir Mas, Kelantan', 'Machang, Kelantan', 'MY', 'Kelantan', NULL, '17040', 'Alor Tualang', 'Current', '27/02/24 05:29:34 PM');
...
--
-- Indexes for table `beneficiary_1011144`
--
ALTER TABLE `beneficiary_1011144`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `beneficiary_1011151`
--
ALTER TABLE `beneficiary_1011151`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `beneficiary_1011179`
--
ALTER TABLE `beneficiary_1011179`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `beneficiary_1011782`
--
ALTER TABLE `beneficiary_1011782`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `passbook_1011144`
--
ALTER TABLE `passbook_1011144`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `passbook_1011151`
--
ALTER TABLE `passbook_1011151`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `passbook_1011179`
--
ALTER TABLE `passbook_1011179`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `passbook_1011782`
--
ALTER TABLE `passbook_1011782`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `beneficiary_1011144`
--
ALTER TABLE `beneficiary_1011144`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `beneficiary_1011151`
--
ALTER TABLE `beneficiary_1011151`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `beneficiary_1011179`
--
ALTER TABLE `beneficiary_1011179`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `beneficiary_1011782`
--
ALTER TABLE `beneficiary_1011782`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `passbook_1011144`
--
ALTER TABLE `passbook_1011144`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `passbook_1011151`
--
ALTER TABLE `passbook_1011151`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `passbook_1011179`
--
ALTER TABLE `passbook_1011179`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `passbook_1011782`
--
ALTER TABLE `passbook_1011782`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
