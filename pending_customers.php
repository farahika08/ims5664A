...
<?php
	...
	if(isset($_POST['search_application'])){
		if(empty($_POST['application_no'])){
            ...
            // Store the application number in the session for later use
            $_SESSION['application_no'] = $_POST['application_no'];
			//$application_no  = $_SESSION['application_no'] = $_POST['application_no'];
			$application_no = $_POST['application_no']; // Use the directly submitted value for the query
...
if (isset($_SESSION['application_no'])) {
         $application_no = $_SESSION['application_no'];
			...
			//------------------------------------------------------------------------------------------ 
						...
						echo '<script>alert("Account Created Successfully\n\nAccount no :'.$acc_no.'\n\nHint : Now get Debit Card, then register e-banking")</script>';
		...
		echo '<script>alert("Application not found(inside account_approve_process)")</script>';

	
	}
}
      	    else{
      	        echo '<script>alert("Application number not found in session")</script>';
      	    }
